...
function renderCss() {
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .brand { display: inline-flex; align-items: flex-end; gap: 14px; color: var(--ink); text-decoration: none; font-weight: 900; }
    .brand img { width: 106px; height: auto; display: block; }
    .brand span { max-width: 25rem; color: var(--muted); font-size: 0.96rem; font-weight: 700; line-height: 1.35; }
    .nav { display: flex; flex-wrap: wrap; align-items: center; gap: 24px; font-weight: 800; }
    .nav a { display: inline-flex; align-items: center; gap: 7px; color: var(--blue); text-decoration: underline; text-decoration-thickness: 1px; text-underline-offset: 0.2em; }
