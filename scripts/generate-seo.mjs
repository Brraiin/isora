...
function renderClaimCss() {
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .topbar-inner { min-height: 106px; display: flex; flex-direction: column; align-items: flex-start; justify-content: center; gap: 16px; padding: 16px 0; }
    .brand { display: inline-flex; align-items: flex-end; gap: 14px; color: #171717; text-decoration: none; }
    .brand img { width: 106px; height: auto; display: block; }
    .brand span { max-width: 25rem; color: #555; font-size: 0.96rem; font-weight: 700; line-height: 1.35; }
    .nav { display: flex; flex-wrap: wrap; align-items: center; gap: 24px; font-weight: 800; }
    .nav a { display: inline-flex; align-items: center; gap: 7px; color: #1455a3; text-decoration: underline; text-decoration-thickness: 1px; text-underline-offset: 0.2em; }
    .nav a:hover { text-decoration-thickness: 2px; }
    .nav a:focus-visible { outline: 2px solid #1455a3; outline-offset: 4px; }
    ...
    @media (max-width: 860px) {
      ...
      .topbar-inner { min-height: 0; padding: 14px 0; }
