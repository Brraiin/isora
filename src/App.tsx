...
const uiText: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    blogSyncSingular: "fiche liée à la veille",
    blogSyncPlural: "fiches liées à la veille",
    blogSyncLatest: "Dernière veille",
    modifiedClaims: "Fiches liées à la veille",
    modifiedClaimChange: "Mise à jour",
    currentMetric: "Mesure actuelle",
    relatedArticle: "Article lié",
    updateSource: "Source",
    claimUpdated: "Fiche liée à la veille",
  ...
  en: {
    ...
    blogSyncSingular: "entry linked to the watch",
    blogSyncPlural: "entries linked to the watch",
    blogSyncLatest: "Latest watch",
    modifiedClaims: "Entries linked to the watch",
    modifiedClaimChange: "Update",
    currentMetric: "Current metric",
    relatedArticle: "Related article",
    updateSource: "Source",
    claimUpdated: "Entry linked to the watch",
